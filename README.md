...
| <sub>**Efficient End-to-End Audio Embeddings Generation for Audio Classification on Target Applications**</sub> | <sub>CNN model pretrained on AudioSet</sub> | <sub>92.32%</sub> | <sub>[Lopez-Meyer2021](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9414229&tag=1)</sub> |  |
