...
| :--- | :--- | :--- | :--- | :--- |
| <sub>**Whisp**</sub> | <sub>CNN with ResNet-38 Pretrained Model with [fast.ai](https://www.fast.ai/)</sub> | <sub>87.25%</sub> | <sub>[a quiet life](https://github.com/aquietlife/whisp#learner-model)</sub> |  |
