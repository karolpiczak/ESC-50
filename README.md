...
| :--- | :--- | :--- | :--- | :--- |
| <sub>**Whisp**</sub> | <sub>CNN with ResNet-34 Pretrained Model using [fast.ai](https://www.fast.ai/)</sub> | <sub>87.25%</sub> | <sub>[a quiet life](https://github.com/aquietlife/whisp#learner-model)</sub> |  |
